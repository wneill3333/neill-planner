...
describe('TimeBlockCalendar', () => {
  ...
  it('positions events correctly based on start time', () => {
    ...
    // 9 AM is 3 hours from 6 AM start = 3 * 60px = 180px
    expect(eventBlock.style.top).toBe('180px');
  });
  ...
  it('calculates event height based on duration', () => {
    ...
    // 1.5 hours = 90 minutes * 1px/min = 90px
    expect(eventBlock.style.height).toBe('90px');
  });
