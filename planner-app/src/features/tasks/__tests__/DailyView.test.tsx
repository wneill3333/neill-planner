...
describe('DailyView', () => {
  ...
  describe('Tab Panels', () => {
    it('should show calendar view with view switcher', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });

      const calendarTab = screen.getByTestId('tab-calendar');
      fireEvent.click(calendarTab);

      // Should show the calendar view with view switcher buttons
      ...
      // Day view is default, so add event button should be visible
      expect(screen.getByTestId('add-event-button')).toBeInTheDocument();
    });

    it('should show notes content', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });

      const notesTab = screen.getByTestId('tab-notes');
      fireEvent.click(notesTab);

      // Should show notes panel with "Add Note" button
  ...
  describe('Add Task Button', () => {
    it('should show Add Task button on tasks tab', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });

      expect(screen.getByTestId('add-task-button')).toBeInTheDocument();
    });

    it('should not show Add Task button on calendar tab', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });
    ...
    it('should not show Add Task button on notes tab', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });
      ...
      expect(screen.queryByTestId('add-task-button')).not.toBeInTheDocument();
      // Should show Add Note button instead
      expect(screen.getByTestId('add-note-button')).toBeInTheDocument();
    });

    it('should open CreateTaskModal when Add Task button is clicked', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });
    ...
    it('should have correct aria-label on Add Task button', () => {
      render(<DailyView />, { wrapper: (props) => <Wrapper {...props} user={mockUser} /> });
