...
describe('TaskList', () => {
  ...
  describe('Category Colors', () => {
    ...
    it('should handle multiple categories', () => {
      ...
      // Category colors are now shown as priority label backgrounds
      const priorityLabels = screen.getAllByTestId('priority-label');
      expect(priorityLabels[0]).toHaveStyle({ backgroundColor: '#FF0000' });
      expect(priorityLabels[1]).toHaveStyle({ backgroundColor: '#00FF00' });
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle tasks with missing categories', () => {
      ...
      // Should fall back to default color on priority label background
      const priorityLabel = screen.getByTestId('priority-label');
