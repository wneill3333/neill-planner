...
describe('Header', () => {
  ...
  describe('Styling', () => {
    it('should have red gradient background', () => {
      ...
      expect(header).toHaveClass('bg-gradient-to-r', 'from-red-900', 'to-red-700');
    });
  ...
  describe('Title', () => {
    ...
    it('should have red text on subtitle', () => {
      render(<Header />);

      const subtitle = screen.getByText('What matters most');
      expect(subtitle).toHaveClass('text-red-100');
    });
  });
