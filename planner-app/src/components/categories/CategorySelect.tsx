...
function CategorySelectComponent({
  ...
  // All options (None + categories)
  // Note: categories already includes the virtual "None" category as first item from selector
  const options = useMemo(
    () => categories.map((cat) => ({ id: cat.id === 'none' ? null : cat.id, name: cat.name, color: cat.color })),
    [categories]
  );
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div
              ...
              style={{ backgroundColor: selectedCategory?.color || NONE_CATEGORY.color }}
              aria-hidden="true"
            />
