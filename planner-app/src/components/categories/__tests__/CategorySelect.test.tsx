...
describe('CategorySelect', () => {
  describe('Rendering', () => {
    ...
    it('shows "None" when no category selected', () => {
      render(
        <CategorySelect
          value={null}
          onChange={vi.fn()}
  ...
  describe('Dropdown Interaction', () => {
    ...
    it('lists all categories with color dots', async () => {
      ...
      // Check for uncategorized option (appears twice: in trigger and dropdown)
  ...
  describe('Visual Indicators', () => {
    ...
    it('shows gray color dot for uncategorized option', async () => {
      const user = userEvent.setup();
      ...
      expect(colorDot).toBeInTheDocument();
      expect(colorDot).toHaveStyle({ backgroundColor: '#9CA3AF' });
    });
  });
});
